...
from .models import Notebook, Smartphone, Category, LatestProducts, Customer, Order, Cart, CartProduct
...
#     categories = Category.objects.get_categories_for_left_sidebar()
#     return render(requset, 'base.html', {'categories': categories})
...
class CheckoutView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        stripe.api_key = 'sk_test_51HuOxeJ4lMTReqIGpO87BxXzxpzEpSVvCpOmLC7u2QGwvZohEwFkHHC7iwd8G1ksjH0A7Ug9CNkDzVsH2HXUM59e0004CENh0I'
...
class PayedOnlineOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        new_order.phone = customer.user.phone
        new_order.address = customer.user.address
